...
{
  "$end", "error", "$undefined", "PARAM", "VAR", "ST", "IDENTIFIER",
  "CONSTANT", "SOLVE", "END", "';'", "$accept", "statements", "statement", YY_NULLPTR
};
#endif
...
{
       1,     2,     6,     8,     7,     3,     9,     0,     0,    11,
      12,    13,    10,    14
};

static const yytype_int8 yycheck[] =
{
       3,     4,     6,    10,     6,     8,     0,    -1,    -1,    10,
      10,     9,     5,    10
};
